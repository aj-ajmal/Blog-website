          ...
          >
            <Link to={`/blogs/${blog.id}`} className="block">
              ...
              <div className="p-6">
                ...
                {/* Read More Indicator */}
                <div className="flex items-center mt-4 font-medium text-blue-600 group-hover:text-blue-700">
      ...
      {blogs.length === 0 && (
        <div className="py-12 text-center">
          <div className="max-w-md p-8 mx-auto rounded-lg bg-gray-50">
            ...
            <h3 className="mb-2 text-xl font-semibold text-gray-700">No blogs in this section</h3>
